...
FUNCTION Q3Point3D_To3DTransformArray({CONST}VAR inVertex: TQ3Point3D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outVertex: TQ3Point3D; numVertices: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
FUNCTION Q3Point3D_To4DTransformArray({CONST}VAR inVertex: TQ3Point3D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outVertex: TQ3RationalPoint4D; numVertices: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
FUNCTION Q3RationalPoint4D_To4DTransformArray({CONST}VAR inVertex: TQ3RationalPoint4D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outVertex: TQ3RationalPoint4D; numVertices: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
{
*****************************************************************************
 **																			 **
 **								Vector Negation								 **
...
FUNCTION Q3Param2D_AffineComb({CONST}VAR param2Ds: TQ3Param2D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3Param2D): TQ3Param2DPtr; C;
FUNCTION Q3RationalPoint3D_AffineComb({CONST}VAR points3D: TQ3RationalPoint3D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3RationalPoint3D): TQ3RationalPoint3DPtr; C;
FUNCTION Q3Point3D_AffineComb({CONST}VAR points3D: TQ3Point3D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3Point3D): TQ3Point3DPtr; C;
FUNCTION Q3RationalPoint4D_AffineComb({CONST}VAR points4D: TQ3RationalPoint4D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3RationalPoint4D): TQ3RationalPoint4DPtr; C;
{
*****************************************************************************
 **																			 **
 **								Matrix Functions							 **
...
FUNCTION Q3Vector3D_TransformQuaternion({CONST}VAR vector: TQ3Vector3D; {CONST}VAR quaternion: TQ3Quaternion; VAR result: TQ3Vector3D): TQ3Vector3DPtr; C;
FUNCTION Q3Point3D_TransformQuaternion({CONST}VAR vector: TQ3Point3D; {CONST}VAR quaternion: TQ3Quaternion; VAR result: TQ3Point3D): TQ3Point3DPtr; C;
{
*****************************************************************************
 **																			 **
 **								Volume Routines							     **
...
FUNCTION Q3BoundingBox_UnionPoint3D({CONST}VAR bBox: TQ3BoundingBox; {CONST}VAR pt3D: TQ3Point3D; VAR result: TQ3BoundingBox): TQ3BoundingBoxPtr; C;
FUNCTION Q3BoundingBox_UnionRationalPoint4D({CONST}VAR bBox: TQ3BoundingBox; {CONST}VAR pt4D: TQ3RationalPoint4D; VAR result: TQ3BoundingBox): TQ3BoundingBoxPtr; C;
FUNCTION Q3BoundingBox_SetFromPoints3D(VAR bBox: TQ3BoundingBox; {CONST}VAR pts: TQ3Point3D; nPts: LONGINT; structSize: LONGINT): TQ3BoundingBoxPtr; C;
FUNCTION Q3BoundingBox_SetFromRationalPoints4D(VAR bBox: TQ3BoundingBox; {CONST}VAR pts: TQ3RationalPoint4D; nPts: LONGINT; structSize: LONGINT): TQ3BoundingBoxPtr; C;
{
*****************************************************************************
 **																			 **
 **								Sphere Routines							     **
...
FUNCTION Q3BoundingSphere_UnionPoint3D({CONST}VAR bSphere: TQ3BoundingSphere; {CONST}VAR pt3D: TQ3Point3D; VAR result: TQ3BoundingSphere): TQ3BoundingSpherePtr; C;
FUNCTION Q3BoundingSphere_UnionRationalPoint4D({CONST}VAR bSphere: TQ3BoundingSphere; {CONST}VAR pt4D: TQ3RationalPoint4D; VAR result: TQ3BoundingSphere): TQ3BoundingSpherePtr; C;
FUNCTION Q3BoundingSphere_SetFromPoints3D(VAR bSphere: TQ3BoundingSphere; {CONST}VAR pts: TQ3Point3D; nPts: LONGINT; structSize: LONGINT): TQ3BoundingSpherePtr; C;
FUNCTION Q3BoundingSphere_SetFromRationalPoints4D(VAR bSphere: TQ3BoundingSphere; {CONST}VAR pts: TQ3RationalPoint4D; nPts: LONGINT; structSize: LONGINT): TQ3BoundingSpherePtr; C;
{$ALIGN RESET}
{$POP}
