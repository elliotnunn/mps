...
extern pascal MenuHandle NewMenu(short menuID, ConstStr255Param menuTitle)
...
#if CGLUESUPPORTED
extern MenuHandle newmenu(short menuID, const char *menuTitle);
extern void appendmenu(MenuHandle menu, const char *data);
extern void insertmenuitem(MenuHandle theMenu, const char *itemString, short afterItem);
extern long menuselect(const Point *startPt);
extern void setmenuitemtext(MenuHandle menu, short item, const char *itemString);
