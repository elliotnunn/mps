/*
	...
	Copyright:	© 1986-1994 by Apple Computer, Inc.
				All Fights Reserved.

	Version:	System 7.1.2 for ETO #14
	Created:	Saturday, March 26, 1994 17:00
*/
...
#elif !defined(evenNewerTemp)
/*--------------------------actb • Alert Color standard System 7 Lookup Table--------------------------*/
	type 'actb' {
...
#else
/*----------------------------actb • newest Alert Color Lookup Table----------------------------*/
	type 'actb' {
			unsigned hex longint = 0;								/* ctSeed				*/
			integer = 1;											/* ctFlags				*/
			integer = $$Countof(ColorSpec) - 1;						/* ctSize				*/
...
// 'thng' is also defined in ImageCodec.r, so if it's already been
// defined there, this won't try to redefine it.

#ifndef __thngIsDefined__
#define __thngIsDefined__
