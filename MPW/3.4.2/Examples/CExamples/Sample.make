...
#
#	Copyright © 1989, 1991, 1994-1995 Apple Computer, Inc.
#	All rights reserved.
#
#	Versions:	
#				1.00				08/88
...
#				1.05				03/94	Updated for Universal Interfaces
#
#	Components:
#				Sample.c			Feb.  1, 1990
#				Sample.r			Feb.  1, 1990
...
COptions = -r {SymOptions} -D OLDROUTINELOCATIONS=0
...
Sample		ƒƒ	Sample.c Sample.r Sample.h Sample.make
	SetFile {Targ} -t APPL -c 'MOOS' -a B

Sample.c.o	ƒ	Sample.h
