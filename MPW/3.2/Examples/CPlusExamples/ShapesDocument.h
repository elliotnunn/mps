...
#	CPlusShapesApp
#
#	This file: ShapesDocument.h	-	Interface to the TShapesDocument Class 
#
...
#ifndef ShapeDocument_Defs
#define ShapeDocument_Defs
...
class TShapesDocument : public TDocument {
	// internal fields
	TShape *fShapeObj;

	// methods not intended for use outside of methods of this class
	void DrawWindow(void);

  public:
	TShapesDocument(short resID);
	~TShapesDocument(void);

	void ChangeShape(int newShape);
	Boolean HasShape(void) {return (fShapeObj != nil);}
	TShape *GetShape(void) {return (fShapeObj);}
	
	// methods from TDocument we override
	void DoUpdate(void);
};

#endif ShapeDocument_Defs
