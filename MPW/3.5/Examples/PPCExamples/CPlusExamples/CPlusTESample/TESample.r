...
#
#	Copyright © 1989, 1994, 1998 Apple Computer, Inc.
#	All rights reserved.
#
#	Versions:
#			2.11					06/98		compatible with 3.1 interfaces
#           2.10                    01/94       for PowerPC
...
resource 'vers' (1) {
	...
	verUS,
	"2.10",
	"2.10, Copyright © 1989, 1994 Apple Computer, Inc."
};

/* we use an MBAR resource to conveniently load all the menus */

resource 'MBAR' (rMenuBar, preload) {
	{ mApple, mFile, mEdit, mDebug };		/* three menus + debug */
};
...
resource 'MENU' (mDebug, preload) {
	mDebug, textMenuProc,
	0b0000000000000000000000000000001,	/* enable debug item */
	enabled, "Debug",
	{
		"Enter Debugger…",
			noicon, nokey, nomark, plain
