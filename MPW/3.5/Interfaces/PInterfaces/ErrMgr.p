{
	...
	Copyright:	© 1987-88, 1993-95, 2000 by Apple Computer, Inc.
				All rights reserved.

	Version:	3.6d1
	Created:	03/20/00

	07/21/95	DGD	Removing LibExport directives.  ToolLibs is a static library
								in all environments.
}
...
PROCEDURE GetSysErrText(msgNbr: LONGINT;errMsg: StringPtr);
...
PROCEDURE GetToolErrText(msgNbr: LONGINT;errInsert: Str255;errMsg: StringPtr);
