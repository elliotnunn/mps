...
UNIT SANE;
 ...
 { The compiler variable GENERATE_881_CALLS must be set true in the source
   code before the USES SANE line if 881 code is to be generated.
 }

  INTERFACE
	
  {$IFC UNDEFINED GENERATE_881_CALLS}
  	{$SETC GENERATE_881_CALLS := FALSE}
  {$ENDC}


	{$IFC GENERATE_881_CALLS}
 ...
 *======================================================================*}
      ...
      Extended80 = ARRAY [0..4] OF INTEGER;
			...
			FUNCTION X96toX80(x: UNIV Extended96): Extended80;
			{ X96toX80 <-- 96 bit x in 80 bit extended format }
	
			FUNCTION X80toX96(x: UNIV Extended80): Extended96;
