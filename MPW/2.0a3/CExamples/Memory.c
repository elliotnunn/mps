...
pascal short DRVROpen(ctlPB, dCtl)
	CntrlParam	*ctlPB;
	DCtlPtr		dCtl;
{
	GrafPtr		savePort;
...
pascal short DRVRPrime(ctlPB, dCtl)
	CntrlParam	*ctlPB;
	DCtlPtr		dCtl;
{
...
pascal short DRVRStatus(ctlPB, dCtl)
	CntrlParam	*ctlPB;
	DCtlPtr		dCtl;
{
	return noErr;			/* Not used in this desk accessory */
...
pascal short DRVRControl(ctlPB, dCtl)
	CntrlParam	*ctlPB;
	DCtlPtr		dCtl;
{
...
static void doCtlEvent(theEvent, globals)
	register	EventRecord	*theEvent;
	Globals 				*globals;	/* Pointer to globals passed */
										/* along the procedure call chain */
{
 ...
 */
static void drawWindow(window, globals)
	WindowPtr	window;
...
pascal short DRVRClose(ctlPB, dCtl)
	char	*ctlPB;
	DCtlPtr	dCtl;
...
static char *text(index, globals)
	int		index;
	Globals	*globals;	/* Pointer to globals passed along the procedure call chain */
{
