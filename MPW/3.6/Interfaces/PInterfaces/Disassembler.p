...
{* except ONE of the target architecture options have preset defaults.							*}
	...
	Disassemble_Vec				 = $00000010;		{*               AltiVec					 					*}
	Disassemble_AltiVec		 = $00000012;		{*               AltiVec + 32-bitPowerPC		*}
...
{* results:																																							*}
	...
	Disassembler_Vec					= $0200;		{* AltiVec vector instruction								*}
...
{* DisassemblerLookupType:																															*}
	...
	DisLookupValue = RECORD										{* A "meaningful" name for each value type:	*}
		...
		2:	(vr:					LongInt;);						{*		Disassembler_Lookup_VecRegister				*}
		3:	(ui:					LongInt;);						{*		Disassembler_Lookup_UImmediate				*}
		4:	(si:					LongInt;);						{*		Disassembler_Lookup_SImmediate				*}
		5:	(absAddress:	LongInt;);						{*		Disassembler_Lookup_AbsAddress				*}
		6:	(relAddress:	LongInt;);						{*		Disassembler_Lookup_RelAddress				*}
...
FUNCTION ppcDisassembler( VAR instruction 	: LongInt; 
															dstAdjust			:	LongInt;
															...
															comment				:	CStringPtr;
															refCon				: UNIV Ptr;
															lookupRoutine	: UNIV Ptr) : DisassemblerStatus; C;
	{*
