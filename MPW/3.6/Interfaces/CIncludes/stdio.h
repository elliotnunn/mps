 ...
 */
	...
	#define stdin        __libGlue_getStdStreams( 0 )
	#define stdout       __libGlue_getStdStreams( 1 )
	#define stderr       __libGlue_getStdStreams( 2 )
...
#elif defined(_POSIX_THREAD_SAFE_FUNCTIONS) && ( defined( __powerc ) || defined( powerc ) )
extern int fileno( FILE *iop );
#else
...
#if !(CALL_NOT_IN_CARBON || __MPWINTERNAL__)
extern FILE *__libGlue_getStdStreams( int fildes ) ;
#endif  /* !(CALL_NOT_IN_CARBON || __MPWINTERNAL__) */
