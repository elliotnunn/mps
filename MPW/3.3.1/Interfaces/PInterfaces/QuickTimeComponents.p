...
FUNCTION SGSettingsDialog (s:SeqGrabComponent;c:SGChannel; numPanels:INTEGER;
	VAR panelList:Component; flags:LONGINT; proc:SGModalFilterProcPtr ; procRefNum:LONGINT):ComponentResult;
...
CONST
	...
	canMovieImportValidateHandles = $100;
	canMovieImportValidateFile = $200;
	dontRegisterWithEasyOpen = $400;
	...
	kMovieImportSetDurationSelect = $C;
	kMovieImportGetAuxiliaryDataTypeSelect = $D;
	kMovieImportValidateSelect 	= $E;
	...
	kMovieExportSetSampleDescriptionSelect = $85;
...
FUNCTION 	MovieImportValidate(ci : MovieImportComponent ;  VAR theFile : FSSpec; theData : Handle ; VAR valid : BOOLEAN) : ComponentResult;
...
FUNCTION	MovieExportSetSampleDescription(ci:MovieExportComponent; 
	desc: SampleDescriptionHandle; mediaType: OSType):ComponentResult; 
