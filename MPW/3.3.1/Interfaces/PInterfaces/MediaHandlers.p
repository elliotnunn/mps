...
kMediaSampleDescriptionChanged 		= $519;
kMediaHasCharacteristic 			= $51A;
kMediaGetOffscreenBufferSize 		= $51B;
kMediaSetHints 						= $51C;
...
FUNCTION MediaGetName (ci:ComponentInstance ; name:Str255; requestedLanguage:LONGINT ; VAR actualLanguage:LONGINT ):ComponentResult;
