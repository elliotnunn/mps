{
	...
	Modified:	Tue, Nov 30, 1993 01:23:47
...
gestaltPlayFromDisk = 7;				{ play from disk available, set by Sound Mgr 3.0 and later }
gestaltMultiChannels = 8;				{ multiple channel support, set by Sound Mgr 3.0 and later }
