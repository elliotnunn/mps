...
extern pascal void SetSysDirection(short newDirection)
...
extern pascal Intl0Hndl GetIntlResource(short theID)
 THREEWORDINLINE(0x3F3C, 0x0006, 0xA9ED);
extern pascal void SetIntlResource(short refNum, short theID, Intl0Hndl intlHandle)
 THREEWORDINLINE(0x3F3C, 0x0008, 0xA9ED);
extern pascal void ClearIntlResourceCache(void)
 THREEWORDINLINE(0x3F3C, 0x0018, 0xA9ED);
extern pascal void GetIntlResourceTable(ScriptCode script, short tableCode, Intl0Hndl *itlHandle, long *offset, long *length)
