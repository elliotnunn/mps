 ...
 *      -------- -------------- ------------------------------------------
 *      12/01/93 Rudy Wang      Removed the declaration of "static Iostream_init iostream_init;"
 *                              and placed it inside iostream_init.c so that we don't get multiple
 *                              copies of this static object all over the place.
 *      12/17/93 Rudy Wang      Made this file universal.
 *------------------------------------------------------------------------
 */

#ifndef __IOSTREAMH__
#define __IOSTREAMH__       1
