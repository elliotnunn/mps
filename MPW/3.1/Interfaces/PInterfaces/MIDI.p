{
Created: Monday, September 18, 1989 at 8:03 PM
    MIDI.p
...
PROCEDURE MIDIGetClientName(clientID: OSType;name: Str255);
...
PROCEDURE MIDIGetPortName(clientID: OSType;portID: OSType;name: Str255);
