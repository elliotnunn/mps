...
#define	Country		verUs, verFrance, verBritain, verGemany,			\
					...
					verPakistan, verIreland = 50, verKorea, verChina,	\
					verTaiwan, verThailand
...
type 'itlb' {
		...
		unsigned hex integer;									/* scripts flags		*/
...
type 'itlc' {
		...
		byte;													/* old keyboard			*/
		unsigned hex byte;										/* general flags		*/
		hex string [40];										/* reserved				*/
};
